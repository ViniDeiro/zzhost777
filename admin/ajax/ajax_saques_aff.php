...
<div class="recent-orders-table-row" style="display: flex; justify-content: space-between;">
    ...
    <div class="flex align-center">
        <div class="paragraph-small color-neutral-100"><?=ver_data($data['data_hora']);?></div>
    </div>
    <div class="flex align-center">
                        ...
                        <form role="form" method="post">
                            <div class="box-body">
                                ...
                                <div class="expfygaming-form">
                                    ...
                                    <input type="text" class="expfygaming-form" id="exampleInputEmail1" value="<?= $data_return['nome']; ?>" readonly>
                                </div>
                                <div class="expfygaming-form">
                                    <label for="exampleInputEmail1">Tipo Pix</label>
                                    <input type="text" class="expfygaming-form" id="exampleInputEmail1" value="<?= $data['tipo']; ?>" readonly>
                                </div>
                                <div class="expfygaming-form">
                                    <label for="exampleInputPassword1">Key Pix</label>
                                    <input type="text" class="expfygaming-form" value="<?= $data['pix']; ?>">
                                </div>
                            </div>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="expfygaming-form">
                                ...
                                <input type="text" class="expfygaming-form" id="nomeUser" value="<?= $data_return['nome']; ?>" readonly>
                            </div>
                            <div class="expfygaming-form">
                                <label for="tipoPix">Tipo Pix</label>
                                <input type="text" class="expfygaming-form" id="tipoPix" value="<?= $data['tipo']; ?>" readonly>
                            </div>
                            <div class="expfygaming-form">
                                <label for="keyPix">Key Pix</label>
                                <input type="text" class="expfygaming-form" id="keyPix" value="<?= $data['pix']; ?>">
                            </div>
