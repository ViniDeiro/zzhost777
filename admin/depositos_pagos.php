                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0 table-centered">
                                        ...
                                        <tbody>
                                            <?php
                                            global $mysqli;
                                            // Consulta unindo transacoes e usuarios
                                            $query_usuarios = "
                                                SELECT 
                                                    t.*,
                                            ...
                                            if ($result_usuarios && mysqli_num_rows($result_usuarios) > 0) {
                                                while ($usuario = mysqli_fetch_assoc($result_usuarios)) {
                                                    // Definir o badge baseado no status
                                                    $cargo_badge = ($usuario['status'] == 'pago') 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- Coluna de Usuário (mobile) + WhatsApp -->
                                                        <td>
                                                            <?= $usuario['user_mobile']; ?>
                                                                ...
                                                                <a href="https://wa.me/55<?= $usuario['user_telefone']; ?>"
                                                                   ...
                                                                   title="Enviar WhatsApp">
                                                                    <i class="lab la-whatsapp"
                                                                       style="color:#25D366; margin-left: 5px;">
                                                                    </i>
                                                                </a>
                                                            <?php endif; ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button"
                                                                    class="btn btn-primary btn-clipboard ms-2"
